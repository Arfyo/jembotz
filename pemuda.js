...
const fvid = {
	 ...
	 { remoteJid: "62895410396931-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
                 "title": `${tampilUcapan} ${pushname}`,
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "62895410396931-1616169743@g.us",
...
pemuda.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        ...
        case 'menu':
        case 'help':
        ptod = "62895410396931@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, `${uwu}JEMBOTZ - KETIK .command UNTUK SIMPEL MENU ${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'ALL MENU📒'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'DEVELOPER👥'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'YOUTUBE🔥'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
        ptod = "62895410396931@s.whatsapp.net"
        stod = `${sender}`
...
│🔖ᴘʀᴇꜰɪx : ${multi ? 'Multi Prefix' : 'No Prefix'}
│🔖ɴᴏᴍᴏʀ ᴏᴡɴᴇʀ : @${otod.split('@')[0]}
│🔖ᴀᴜᴛᴏ ᴄᴏᴍᴘᴏꜱɪɴɢ : ${settings.autocomposing}
...
│🔖ʙɪᴏ : ${stst}
│🔖ɴᴏᴍᴏʀ : @${stod.split('@')[0]}
│🔖ɪɴꜰᴏ ɴᴏᴍᴏʀ : ${num.data.countrycode} - ${num.data.carrier.type} - ${num.data.carrier.name}
└⬣
...
╭─⬣ 𝗖𝗼𝗺𝗺𝗮𝗻𝗱
│🔖${prefix}ᴀᴜᴛᴏʀᴇꜱᴘᴏɴ [ ᴏɴ/ᴏꜰꜰ ]
│🔖${prefix}ʙᴄ [ ᴛᴇᴋꜱ/ʀᴇᴘʟʏ ɢɪꜰ/ɪᴍᴀɢᴇ/ᴠɪᴅᴇᴏ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ ]
│🔖${prefix}ᴛᴏʙᴄ [ ʀᴇᴘʟʏ ꜱᴛɪᴄᴋᴇʀ/ᴀᴜᴅɪᴏ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ ]
│🔖${prefix}ʀᴇᴛᴜʀɴ [ ᴊᴀᴠᴀꜱᴄʀɪᴘᴛ ]
│🔖${prefix}ᴄʟᴇᴀʀᴀʟʟ
│🔖${prefix}ᴅᴇʟᴄʜᴀᴛ
│🔖${prefix}ᴍᴜᴛᴇ [ ʙɪꜱᴜᴋᴀɴ ]
│🔖${prefix}ᴜɴᴍᴜᴛᴇ [ ᴊᴀɴɢᴀɴ ʙɪꜱᴜᴋᴀɴ ]
│🔖${prefix}ᴘᴜʙʟɪᴄ
│🔖${prefix}ꜱᴇʟꜰ
│🔖${prefix}ꜱᴘᴀᴍ [ ᴛᴇᴋꜱ|ᴊᴜᴍʟᴀʜ ]
│🔖${prefix}ᴅᴇᴍᴏᴛᴇᴀʟʟ 
│🔖${prefix}ᴘʀᴏᴍᴏᴛᴇᴀʟʟ
│🔖${prefix}ᴀᴅᴅᴄᴍᴅ [ ᴛᴇᴋꜱ ʀᴇᴘʟʏ ꜱᴛᴄ ]
│🔖${prefix}ᴅᴇʟᴄᴍᴅ [ ʀᴇᴘʟʏ ꜱᴛᴄ ]
│🔖${prefix}ʟɪꜱᴛᴄᴍᴅ
│🔖${prefix}ꜱᴘᴀᴍꜱᴡ [ ᴛᴇᴋꜱ|ᴊᴜᴍʟᴀʜ ]
│🔖${prefix}ᴜᴘꜱᴡᴛᴇᴋꜱ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴜᴘꜱᴡʟᴏᴋᴀꜱɪ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴜᴘꜱᴡᴀᴜᴅɪᴏ [ ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ ]
│🔖${prefix}ᴜᴘꜱᴡᴠᴏɪᴄᴇ [ ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ ]
│🔖${prefix}ᴜᴘꜱᴡꜱᴛɪᴄᴋᴇʀ [ ʀᴇᴘʟʏ ꜱᴛɪᴄᴋᴇʀ ]
│🔖${prefix}ᴜᴘꜱᴡɪᴍᴀɢᴇ [ ʀᴇᴘʟʏ ɪᴍᴀɢᴇ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ ]
│🔖${prefix}ᴜᴘꜱᴡɢɪꜰ [ ʀᴇᴘʟʏ ɢɪꜰ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ ]
│🔖${prefix}ᴜᴘꜱᴡᴠɪᴅᴇᴏ [ ʀᴇᴘʟʏ ᴠɪᴅᴇᴏ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ ]
│🔖${prefix}ꜱʜᴜᴛᴅᴏᴡɴ
│🔖${prefix}ᴏꜰꜰʟɪɴᴇ [ ᴀʟᴀꜱᴀɴ ]
│🔖${prefix}ᴏɴʟɪɴᴇ
│🔖${prefix}ᴇxɪꜰ [ ɴᴀᴍᴀ|ᴀᴜᴛʜᴏʀ ]
│🔖${prefix}ꜱᴇᴛᴘʀᴏꜰɪʟᴇ [ ʀᴇᴘʟʏ ɪᴍᴀɢᴇ ]
│🔖${prefix}ꜱᴇᴛɴᴀᴍᴇ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ꜱᴇᴛᴘʀᴇꜰɪx [ ᴍᴜʟᴛɪ/ɴᴏᴘʀᴇꜰ ]
│🔖${prefix}ꜱᴇᴛʙɪᴏ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ʟᴇᴀᴠᴇ [ ᴋᴇʟᴜᴀʀ ]
│🔖${prefix}ʀᴇꜱᴛᴀʀᴛ 
│🔖${prefix}ᴊᴏɪɴ [ ʟɪɴᴋ ɢʀᴏᴜᴘ ]
│🔖${prefix}ᴀᴅᴅʀᴇꜱᴘᴏɴ [ ᴛᴀɴʏᴀ|ᴊᴀᴡᴀʙ ]
│🔖${prefix}ᴅᴇʟʀᴇꜱᴘᴏɴ [ ɴᴀᴍᴀ ]
│🔖${prefix}Q [ ʀᴇᴘʟʏ ᴍᴇꜱꜱᴀɢᴇ ]
│
├─⬣ 𝗩𝗜𝗥𝗨𝗦 𝗠𝗘𝗡𝗨⚔️ 
│🔖${prefix}ᴠɪʀᴛᴇx
│🔖${prefix}ᴛᴏᴠɪʀɢᴀᴍ [ʀᴇᴘʟʏ ꜱᴛɪᴄᴋᴇʀ]
│🔖${prefix}ʙᴜɢᴋᴀᴛᴀʟᴏɢ
│🔖${prefix}ʙᴜɢʟᴏᴄ
│🔖${prefix}ʙᴜɢʀᴏᴡ
│🔖${prefix}ʙᴜɢʟɪɴᴋ
...
│🔖${prefix}ɪɴꜰᴏɢᴇᴍᴘᴀ
│🔖${prefix}ʜᴇʀᴏʟɪꜱᴛ
│🔖${prefix}ʜᴇʀᴏᴅᴇᴛᴀɪʟ [ ʜᴇʀᴏ ]
│🔖${prefix}ɢᴏᴏɢʟᴇ [ ꜱᴇᴀʀᴄʜ ]
│🔖${prefix}ɢɪᴍᴀɢᴇ [ ꜱᴇᴀʀᴄʜ ]
│🔖${prefix}ᴡɪᴋɪ [ ꜱᴇᴀʀᴄʜ ]
│🔖${prefix}ᴍᴇᴅɪᴀꜰɪʀᴇ [ ʟɪɴᴋ ]
│🔖${prefix}ʏᴛꜱᴇᴀʀᴄʜ [ ᴊᴜᴅᴜʟ ]
│🔖${prefix}ʏᴛᴍᴘ4 [ ʟɪɴᴋ ʏᴛ ]  ᴘᴇʀʙᴀɪᴋᴀɴ
│🔖${prefix}ʏᴛᴍᴘ3 [ ʟɪɴᴋ ʏᴛ ]
│🔖${prefix} [ ᴊᴜᴅᴜʟ ʟᴀɢᴜ ]
│🔖${prefix}ᴠɪᴅᴇᴏ [ ᴊᴜᴅᴜʟ ᴠɪᴅᴇᴏ ]
│🔖${prefix}ᴛɪɴʏᴜʀʟ [ ʟɪɴᴋ ]
│🔖${prefix}ꜰᴇᴛᴄʜ [ ʟɪɴᴋ ]
│🔖${prefix}ɪɢᴅʟ [ ʟɪɴᴋ ]
│🔖${prefix}ᴛɪᴋᴛᴏᴋᴅʟ [ ʟɪɴᴋ ]
│🔖${prefix}ᴘɪɴᴛᴇʀᴇꜱᴛ [ ꜱᴇᴀʀᴄʜ ]
│🔖${prefix}ʟɪʀɪᴋ [ ᴊᴜᴅᴜʟ ]
│🔖${prefix}ᴛᴏᴜʀʟ [ ʀᴇᴘʟʏ ɪᴍᴀɢᴇ/ᴠɪᴅᴇᴏ ]
│🔖${prefix}ʀᴇꜱᴇᴘᴍᴀꜱᴀᴋᴀɴ [ ᴊᴜᴅᴜʟ ]
│🔖${prefix}ᴀʀᴛɪᴍɪᴍᴘɪ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ʙɪʟᴀɴɢᴀɴɢᴋᴀ [ ᴀɴɢᴋᴀ ]
│🔖${prefix}ᴋᴀʟᴋᴜʟᴀᴛᴏʀ [ ᴀɴɢᴋᴀ ]
│🔖${prefix}ꜰᴀɴᴄʏᴛᴇxᴛ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ɢɪᴛʜᴜʙꜱᴛᴀʟᴋ [ ᴜꜱᴇʀɴᴀᴍᴇ ]
│🔖${prefix}ᴛʀᴀɴꜱʟᴀᴛᴇ [ ᴋᴏᴅᴇʙʜꜱ|ᴛᴇᴋꜱ ]
│🔖${prefix}ꜱꜱ [ ʟɪɴᴋ ]
│🔖${prefix}ᴛɪᴋᴛᴏᴋᴀᴜᴅɪᴏ [ ʟɪɴᴋ ]
│🔖${prefix}ɪɢꜱᴛᴏʀʏ [ ʟɪɴᴋ ]
│🔖${prefix}ʟɪɴᴋᴡᴀ
│🔖${prefix}ꜱᴛᴏʀᴇ [ Qᴜᴇʀʏ ]
│🔖${prefix}ꜰʙ [ ʟɪɴᴋ ]
...
│
├─⬣ 𝗠𝗮𝗸𝗲𝗿 𝗠𝗲𝗻𝘂🥀
│🔖${prefix}ꜰᴏʟɪᴏᴋɪʀɪ 「 ᴛᴇxᴛ 」
│🔖${prefix}ꜰᴏʟɪᴏᴋᴀɴᴀɴ 「 ᴛᴇxᴛ 」
│🔖${prefix}ɴᴜʟɪꜱᴋᴀɴᴀɴ 「 ᴛᴇxᴛ 」
│🔖${prefix}ɴᴜʟɪꜱᴋɪʀɪ 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴍᴀᴛʀɪx [ ᴛᴇᴋꜱ ]
│🔖${prefix}ɢᴏᴏɢʟᴇᴛxᴛ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ꜱᴘɪᴅᴇʀᴍᴀɴ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴇxᴘʀᴇꜱꜱ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴅᴀɴᴄᴇ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ʙʟᴀᴄᴋʙɪʀᴅ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ʜᴀʟʟᴏᴡᴇᴇɴ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴠᴀᴍᴘɪʀᴇ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴄᴏᴅᴇᴛxᴛ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴛᴇxᴛ3ᴅ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴡᴀʀʀɪᴏʀ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴍᴀᴋᴇʀ2ᴅ2 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴍᴀᴋᴇʀ2ᴅ3 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴍᴀᴋᴇʀ2ᴅ4 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴍᴀᴋᴇʀ3ᴅ 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴍᴀᴋᴇʀ3ᴅ2 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴍᴀᴋᴇʀ3ᴅ3 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴍᴀᴋᴇʀ3ᴅ4 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴛʀᴀɴꜱꜰᴏʀᴍᴇʀ 「 ᴛᴇxᴛ 」
│🔖${prefix}ɢᴏᴏɢʟᴇᴛxᴛ 「 ᴛᴇxᴛ 」
│🔖${prefix}ʙᴀᴛᴛʟᴇꜰɪᴇʟᴅ 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴄᴏꜰꜰᴇᴇᴄᴜᴘ 「 ᴛᴇxᴛ 」
│🔖${prefix}ᴄᴏꜰꜰᴇᴇᴄᴜᴘ2 「 ᴛᴇxᴛ 」
│🔖${prefix}ɴᴇᴏɴ 「 ᴛᴇxᴛ 」
│🔖${prefix}ɢʟᴏᴡ 「 ᴛᴇxᴛ 」
│🔖${prefix}ꜱᴜᴍᴍᴇʀ 「 ᴛᴇxᴛ 」
│🔖${prefix}ꜰʟᴏᴡᴇʀ 「 ᴛᴇxᴛ 」
...
├──⬣ 𝗚𝗿𝗼𝘂𝗽 𝗺𝗲𝗻𝘂🤤
│🔖${prefix}ɢᴇᴛᴘɪᴄᴛ [ @ᴛᴀɢ ]
│🔖${prefix}ɢᴇᴛɴᴀᴍᴇ [ ʀᴇᴘʟʏ ᴛᴀʀɢᴇᴛ ]
│🔖${prefix}ɢᴇᴛʙɪᴏ [ ʀᴇᴘʟʏ ᴛᴀʀɢᴇᴛ ]
│🔖${prefix}ᴘʀᴏᴍᴏᴛᴇ [ @ᴛᴀɢ ]
│🔖${prefix}ᴅᴇᴍᴏᴛᴇ [ @ᴛᴀɢ ]
│🔖${prefix}ᴀɴᴛɪʟɪɴᴋ [ 1/0 ]
│🔖${prefix}ɴꜱꜰᴡ [ 1/0 ]
│🔖${prefix}ᴄʀᴇᴀᴛᴇɢʀᴜᴘ [ ɴᴀᴍᴀ|@ᴛᴀɢ ]
...
│🔖${prefix}ᴀᴅᴅ [ ɴᴏᴍᴏʀ ]
│🔖${prefix}ɢᴇᴛᴅᴇꜱᴋɢᴄ
│🔖${prefix}ꜱɪᴅᴇʀ [ ʀᴇᴘʟʏ ᴘᴇꜱᴀɴ ʙᴏᴛ ]
│🔖${prefix}ʜᴀᴄᴋᴇᴅ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ꜱᴇᴛɴᴀᴍᴇɢᴄ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ꜱᴇᴛᴅᴇꜱᴋɢᴄ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ꜰɪᴛɴᴀʜ [ @ᴛᴀɢ|ᴛᴇᴋꜱ1|ᴛᴇᴋꜱ2 ]
│🔖${prefix}ᴋᴏɴᴛᴀᴋ [ @ᴛᴀɢ|ɴᴀᴍᴀ ]
│🔖${prefix}ᴋᴏɴᴛᴀɢ [ @ᴛᴀɢ|ɴᴀᴍᴀ ]
│🔖${prefix}ᴏᴘᴇɴɢᴄ
│🔖${prefix}ᴄʟᴏꜱᴇɢᴄ
│🔖${prefix}ʀᴇꜱᴇᴛʟɪɴᴋɢᴄ
│🔖${prefix}ʟɪɴᴋɢʀᴜᴘ
...
│🔖${prefix}ᴘᴇᴍᴜᴅᴀʟɪɴᴇ
│🔖${prefix}ʜɪᴅᴇᴛᴀɢ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ꜱᴛɪᴄᴋᴛᴀɢ [ ɴᴀᴍᴀ ꜱᴛɪᴄᴋᴇʀ ]
│🔖${prefix}ᴛᴏᴛᴀɢ [ ʀᴇᴘʟʏ ᴍᴇᴅɪᴀ ]
│
├─⬣ 𝗡𝗦𝗙𝗪 𝗠𝗘𝗡𝗨🔞
│🔖${prefix}ᴛʀᴀᴘɴɪᴍᴇ
│🔖${prefix}ɴᴇᴋᴏ
...
│🔖${prefix}ᴛᴀᴋᴇꜱᴛɪᴄᴋ [ ɴᴀᴍᴀ|ᴀᴜᴛʜᴏʀ ]
│🔖${prefix}ᴄᴏʟᴏɴɢ [ ʀᴇᴘʟʏ ꜱᴛɪᴄᴋᴇʀ ]
│🔖${prefix}ꜱᴛɪᴄᴋᴇʀ
│🔖${prefix}ꜱᴇᴍᴏᴊɪ [ ᴇᴍᴏᴊɪ ]
│🔖${prefix}ᴀᴛᴛᴘ [ ᴛᴇᴋꜱ ]
│🔖${prefix}ᴛᴏɪᴍɢ
│🔖${prefix}ᴛᴏᴍᴘ3 [ ʀᴇᴘʟʏ ᴠɪᴅᴇᴏ ]
│🔖${prefix}ᴛᴏᴍᴘ4 [ ʀᴇᴘʟʏ ꜱᴛɪᴄᴋᴇʀ ɢɪꜰ ]
│🔖${prefix}ʀᴏʙᴏᴛ [ ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ ]
│🔖${prefix}ʙᴀʟɪᴋ [ ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ ]
│🔖${prefix}ʙᴀꜱꜱ [ ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ ]
│🔖${prefix}ɢᴇᴍᴜᴋ [ ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ ]
│🔖${prefix}ᴅᴇᴛɪᴋᴠɴ [ ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ ᴄᴀᴘᴛɪᴏɴ ᴀɴɢᴋᴀ ]
│🔖${prefix}ᴅᴇᴛɪᴋᴠɪᴅᴇᴏ [ ʀᴇᴘʟʏ ᴠɪᴅᴇᴏ ᴄᴀᴘᴛɪᴏɴ ᴀɴɢᴋᴀ ]
│🔖${prefix}ᴛᴛꜱ [ ᴋᴏᴅᴇʙʜꜱ ᴛᴇᴋꜱ ]
│
├─⬣ 𝗦𝘁𝗼𝗿𝗮𝗴𝗲 𝗠𝗲𝗻𝘂📂
│🔖${prefix}ᴀᴅᴅꜱᴛɪᴄᴋᴇʀ [ ɴᴀᴍᴀ ]
│🔖${prefix}ᴅᴇʟꜱᴛɪᴄᴋᴇʀ [ ɴᴀᴍᴀ ]
│🔖${prefix}ᴀᴅᴅᴠɴ [ ɴᴀᴍᴀ ]
│🔖${prefix}ᴅᴇʟᴠɴ [ ɴᴀᴍᴀ ]
│🔖${prefix}ᴀᴅᴅɪᴍᴀɢᴇ [ ɴᴀᴍᴀ ]
│🔖${prefix}ᴅᴇʟɪᴍᴀɢᴇ [ ɴᴀᴍᴀ ]
│🔖${prefix}ʟɪꜱᴛɪᴍᴀɢᴇ
│🔖${prefix}ʟɪꜱᴛꜱᴛɪᴄᴋᴇʀ
│🔖${prefix}ʟɪꜱᴛᴠɴ
│
...
│
├─⬣ 𝗢𝘁𝗵𝗲𝗿 & 𝗙𝘂𝗻 𝗠𝗲𝗻𝘂🤓
│🔖${prefix}ᴄᴀʀɪᴘᴇꜱᴀɴ [ ᴛᴇᴋꜱ|ᴊᴜᴍʟᴀʜ ]
│🔖${prefix}ꜱʟᴏᴛꜱ
│🔖${prefix}ꜱᴜɪᴛ [ ɢᴜɴᴛɪɴɢ/ʙᴀᴛᴜ/ᴋᴇʀᴛᴀꜱ ]
│🔖${prefix}ᴛᴀɢ [ ɴᴏᴍᴏʀ ]
│🔖${prefix}ᴛᴀɢᴍᴇ
│🔖${prefix}ʀᴇᴀᴅᴍᴏʀᴇ [ ᴛᴇᴋꜱ1|ᴛᴇᴋꜱ2 ]
│🔖${prefix}ꜰɪᴛɴᴀʜᴘᴄ [ ɴᴏᴍᴏʀ|ᴛᴇᴋꜱ1|ᴛᴇᴋꜱ2 ]
│🔖${prefix}ᴄʜᴀᴛ [ ɴᴏᴍᴏʀ|ᴛᴇᴋꜱ ]
│🔖${prefix}ꜰᴅᴇꜰᴀᴄᴇ [ ʀᴇᴘʟʏɪᴍɢ ʟɪɴᴋ|ᴛᴇᴋꜱ1|ᴛᴇᴋꜱ2 ]
│🔖${prefix}ʟɪꜱᴛɢʀᴜᴘ
│🔖${prefix}ʙᴀɪʟᴇʏꜱ [ ʀᴇᴘʟʏ ᴍᴇꜱꜱᴀɢᴇ ]
│🔖${prefix}ɢᴇᴛᴄᴀᴘᴛɪᴏɴ [ ʀᴇᴘʟʏ ᴍᴇꜱꜱᴀɢᴇ ]
│🔖${prefix}ᴘᴀɴᴛᴜɴ
│🔖${prefix}ᴛᴏꜱᴘᴀᴍ [ ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ/ꜱᴛɪᴄᴋᴇʀ/ɪᴍᴀɢᴇ|ᴊᴜᴍʟᴀʜ ]
│🔖${prefix}ꜱʜᴀʀᴇʟᴏᴄᴋ [ ᴛᴇᴋꜱ1|ᴛᴇᴋꜱ2 ]
│🔖${prefix}ᴅᴀᴅᴜ
└─────────────────⬣
🛑 GUNAKAN BOT SECARA BIJAK!
${uwu}`
pemuda.sendMessage(from, menu, text, { quoted: ftrol, thumbnail: fs.readFileSync('./pemuda_1.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtube.com/channel/UCcOCTySo6X1K5tziHZxq7Qw`}}})
break
case 'command':
 listMsg = {
 buttonText: 'ʟɪꜱᴛ ᴍᴇɴᴜ',
 footerText: '© ʙʏ ᴀʙɪʟɢᴀɴᴢ',
 description: `Hai kak @${stod.split('@')[0]}, Silahkan pilih menu disini, Kalau lu makek Wa Haram, dan gak muncul, Ketik .allmenu`,
 sections: [
                     {
...
client.browserDescription = ['JEMBOTZ','Desktop','3.0']
...
break
		...
		case 'sc':
		case 'sourcecode':
		pemuda.sendMessage(from, { text: "LOH NDAK TAU KOK TANYA SAYA :V :\nhttps://youtube.com/channel/UCxJw6QpgyIjVeaN0dKOUItQ", matchedText: 'https://youtube.com/channel/UCxJw6QpgyIjVeaN0dKOUItQ', description: "", title: "CLICK BANG :V", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
...
*_Permainan Seri🗿👌*
*Support JEMBOTZ* 
https://youtube.com/channel/UCxJw6QpgyIjVeaN0dKOUItQ`
ucapan2 = `*🎳 Result Game Tictactoe 🎲*
...
Giliran = @${tty.er1.split('@')[0]}`
 pemuda.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.er1,tty.er2]}})
     ...
     pemuda.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer JEMBOTZ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://youtube.com/channel/UCxJw6QpgyIjVeaN0dKOUItQ"}}})
	}
    }
    }
    }
